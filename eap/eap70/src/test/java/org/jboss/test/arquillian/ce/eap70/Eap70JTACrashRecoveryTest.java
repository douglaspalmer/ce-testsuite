 ...
 */
@Template(url = "https://raw.githubusercontent.com/${quickstart.repository:jboss-openshift}/openshift-quickstarts/${quickstart.branch:master}/jta-crash-rec-eap7/eap70-qs-test-s2i.json", parameters = {
        ...
        @TemplateParameter(name = "CONTEXT_DIR", value = "jta-crash-rec-eap7")})

public class Eap70JTACrashRecoveryTest extends EapJTACrashRecoveryTestBase {
