 ...
 */
@Template(url = "https://raw.githubusercontent.com/${quickstart.repository:jboss-openshift}/openshift-quickstarts/${quickstart.branch:master}/jta-crash-rec-eap7/eap71-qs-test-s2i.json", parameters = {
...
public class Eap71JTACrashRecoveryTest extends EapJTACrashRecoveryTestBase {
